...
import { DEFAULT_FACEBOOK_LIVE } from "./facebookLive";
...
export const SITE_PAGES = [
  {
    ...
    sections: [
      ...
      },
      {
        key: "facebookLive",
        label: "Facebook Live",
        hint: "Managed under Banners — homepage live stream when the church page is broadcasting",
        kind: "inbox",
        cms: "facebookLive",
        actions: ["edit"],
        actionLabels: { edit: "Manage" },
  ...
  },
  {
    ...
    sections: [
      ...
      { key: "church", label: "Church details & socials", ...copy([
        ...
        { name: "notificationEmail", label: "Primary admin notification email" },
        { name: "secondaryNotificationEmails", label: "Secondary notification emails (comma-separated)", type: "textarea" },
...
export function mergePageContent(storedPages = {}) {
  ...
  SITE_PAGES.forEach((page) => {
    ...
    page.sections.forEach((section) => {
      ...
      if (section.kind === "inbox" && section.cms !== "monthWelcome" && section.cms !== "facebookLive") return;
    ...
    Object.keys(stored).forEach((key) => {
      ...
      if (meta?.kind === "inbox" && meta.cms !== "monthWelcome" && meta.cms !== "facebookLive") return;
