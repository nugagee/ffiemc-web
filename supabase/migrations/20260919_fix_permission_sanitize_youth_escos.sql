-- Fix admin permission saves: keep youth Escos and other newer page sections,
-- and stop stripping dashboard feature permissions (programs, banners, etc.).
...
declare
  ...
  v_allowed text[] := array[
    ...
    'sermons','blog','testimonies','contact','prayer','join','donate'
  ];
begin
