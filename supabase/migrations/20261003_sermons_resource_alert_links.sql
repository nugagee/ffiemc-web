-- Point Sunday / Choir / Bible Study alerts at /sermons (Daily Manna stays on /blog)
    ...
    from (
      ...
      from (
        ...
        select
          ...
          case r.kind
            when 'sunday_sermon' then '/sermons?tab=sunday-sermon'
            when 'choir_ministration' then '/sermons?tab=choir'
            when 'bible_study' then '/sermons?tab=bible-study'
